source("figure_refPCI generator/library_path.R")
...
p1 = ggplot(  data_vertebrate,aes(data_vertebrate[,xlabel],data_vertebrate[,ylabel], fill=clade,text=species) )+ geom_point(shape=21,size=7,alpha=0.7)+
  ...
  labs(
    caption =substitute(paste("PGLS "," R"^2,pgls_eq,
...
jpeg(paste(path_figure,"pref1_vert_busco_as_longevity.jpg",sep=""), width = 6100/resolution, height = 5500/resolution,res=700/resolution)
print(p1)
dev.off()
...
jpeg(paste(path_figure,"pref1_vert_busco_as_body.jpg",sep=""), width = 6100/resolution, height = 5500/resolution,res=700/resolution)
print(p1)
dev.off()
...
jpeg(paste(path_figure,"pref1_vert_busco_as_dNdS.jpg",sep=""), width = 8200/resolution, height = 5500/resolution,res=700/resolution)
print(p1)
dev.off()
...
p1 = ggplot(  data_invertebrate,aes(data_invertebrate[,xlabel],data_invertebrate[,ylabel], fill=clade,text=species) )+ geom_point(shape=21,size=7,alpha=0.7)+
  scale_fill_manual("Clades",values=vectorColor)+ ggtitle("Major introns (BUSCO genes)")+ 
...
jpeg(paste(path_figure,"pref1_invert_busco_as_longevity.jpg",sep=""), width = 6100/resolution, height = 5500/resolution,res=700/resolution)
print(p1)
dev.off()
...
jpeg(paste(path_figure,"pref1_invert_busco_as_body.jpg",sep=""), width = 6100/resolution, height = 5500/resolution,res=700/resolution)
print(p1)
dev.off()
...
p1
jpeg(paste(path_figure,"pref1_invert_busco_as_dNdS.jpg",sep=""), width = 8200/resolution, height = 5500/resolution,res=700/resolution)
print(p1)
dev.off()

############## Supplementary Figure 6

imgA = load.image(paste(path_figure,"pref1_vert_busco_as_longevity.jpg",sep=""))
imgB = load.image(paste(path_figure,"pref1_vert_busco_as_body.jpg",sep=""))
imgC = load.image(paste(path_figure,"pref1_vert_busco_as_dNdS.jpg",sep=""))
imgD = load.image(paste(path_figure,"pref1_invert_busco_as_longevity.jpg",sep=""))
imgE = load.image(paste(path_figure,"pref1_invert_busco_as_body.jpg",sep=""))
imgF = load.image(paste(path_figure,"pref1_invert_busco_as_dNdS.jpg",sep=""))
