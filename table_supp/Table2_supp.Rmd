...
kbl(data_1, format="latex",booktabs = T, escape = F, align = "c",
  ...
  footnote(
    symbol = c("The sources from which the lifespan and the body length information was taken are listed in data/Data9 supp.pdf in the GitHub repository (see Data and code availability).")
