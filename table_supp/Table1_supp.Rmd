...
data_1 = data_1[,c("clade","nb_rnaseq","CoverageBuscoExon","prop_analyzable_busco","mean_intron_per_gene_busco","prop_major_sv_busco","mean_as_busco","prop_rare_sv_protein_coding")]
data_1$CoverageBuscoExon = round(data_1$CoverageBuscoExon,3)
data_1$prop_analyzable_busco = round(data_1$prop_analyzable_busco,3)
...
kbl(data_1, format="latex" , booktabs = T, escape = F, align = "c", 
  ...
  footnote(
           alphabet = c("Median \\\\textit{per}-base read coverage computed on BUSCO gene exons",
                        "Fraction of analyzable introns (\\\\textit{i.e.} with N $\\\\geq$ 10) among BUSCO genes",
                        "Proportion of major introns for which alternative splicing has been detected (\\\\textit{i.e.} with N2 $\\>$ 0) among BUSCO genes",
